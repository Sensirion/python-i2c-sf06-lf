...
1. Install the SF06-LF driver and all required packages as described in :ref:`Installation`.
...
4. Connect the SF06-LF sensor to the SEK-SensorBridge
...
.. literalinclude:: ../examples/example_usage_sensorbridge_sf06_lf.py
    :language: python
...
1. Install the SF06-LF driver and all required packages as described in :ref:`Installation`.
2. Connect the SF06-LF sensor to the I²C port of your system (for example to the I²C port 1 of a Raspberry Pi).
3. Run the example script from the root of the repository.
   ...
   .. sourcecode:: bash
      ...
      python examples/example_usage_linux_sf06_lf.py --i2c-port <your I2C port>

Example script
~~~~~~~~~~~~~~

.. literalinclude:: ../examples/example_usage_linux_sf06_lf.py
    :language: python
