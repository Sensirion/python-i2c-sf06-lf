...
#
"""
The class Sf06LfDeviceBase implements the low level interface of the sensor.
The class Sf06LfDevice extends the Sf06LfDeviceBase. It provides additional functions to ease the use of the
sensor.
"""
...
class Sf06LfDeviceBase:
    ...
    def start_h2o_continuous_measurement(self):
        ...
        .. note::
            ...
            accuracy deviations (% m.v.) can occur while the sensor warms-up (60ms for SLF3x, 120ms for LD2x
            including the 12 ms for measurement initialization).
        """
    ...
    def start_ipa_continuous_measurement(self):
        ...
        .. note::
            The first measurement result will be available after 12ms. Due to the thermal measurement principle small
            accuracy deviations (% m.v.) can occur while the sensor warms-up (60ms for SLF3x, 120ms for LD2x including
    ...
    def read_measurement_data_raw(self):
        ...
        .. note::
            ...
            Small accuracy deviations (% m.v.) can occur during the first 60ms for SLF3x, 120ms for LD2x (including
            the 12ms initialization)
        """
